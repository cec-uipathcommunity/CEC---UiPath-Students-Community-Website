...
>
  <div className="flex flex-col min-h-screen bg-black/85">
    <div className="container flex flex-col flex-1 px-6 py-12 mx-auto">
      <div className="flex-1 lg:flex lg:items-center lg:-mx-6">
        <div className="text-white lg:w-1/2 lg:mx-6">
          ...
          Welcome to our Contact Us page! Have questions, suggestions, or need support? Drop us a message through the contact form below. Our team is here to help and values your input. For real-time updates and community discussions, connect with us on social media. Thanks for being part of the CEC - UiPath Students Community!
          </p>
              ...
              >
                ...
                >
                  ...
                  />
                                ...
                                <a target="blank" href="cecuipathstudentscommunity@gmail.com" class="text-[#007bff] text-sm ml-3">
                               
                                <h2 class="text-lg font-extrabold">Email</h2>
                                    <strong>cecuipathstudentscommunity@gmail.com</strong>
                                </a>
          </div>
