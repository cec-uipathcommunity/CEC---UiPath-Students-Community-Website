...
import sak_img from '../image/sak_photo.jpeg';
import ash_img from '../image/IMG_2558 - Ashay Shetty.jpeg';
import thej_img from '../image/IMG_4819 - Shankara thejaswi.jpeg';
import amul_img from '../image/1704377290752 - Amulya.jpg';
import '../styles/Team.css'
const people = [
  {
    name: "Sakshath Rai K",
    role: "UiPath Student Developer Champion ",
    imageUrl:
      sak_img,
  },
  {
            ...
            <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
              ...
              <div class="p-5">
                <h3 class="text-xl font-bold tracking-tight text-gray-900 dark:text-white ">
                  <a href="www.google.com">{people[0].name}</a>
                </h3>
